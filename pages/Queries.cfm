...
<div class="banner">
		...
		<button onclick="topFunction()" id="scroll-to-top-button" title="Go to Home" style="font-size: 11px"><a href="Index.cfm">HOME > QUERIES </a></button>
		
		<video autoplay loop muted plays-inline style="filter: blur(1.5px)" class="back-vid"><source src="../vids/pexels-yaroslav-shuraev-5418124 (1).mp4" type="video/mp4"></video>
		...
		<nav class="fixed-top">
			...
			<ul>
				...
				<cfoutput query="Query">
					<li><a href="#Query_Url#?theQuery=#Query.Query_Title#" title="Go To #Query_Title#">#Query_Title#</a></li>
				</cfoutput>
					...
					<section class="tiles">	
							...
							<article>
									<header class="major">
										...
										<a href="#Query_Url#?theQuery=#Query.Query_Title#" class="button small next scrolly">Click Here</a>			
									</header>
								</article>
					</cfoutput>
